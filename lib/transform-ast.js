...
module.exports = (ast, tagName, className, outputFolder, superClass) => {
  require('mkdirp')(outputFolder, error => {
    ...
    ast.program.body.push(defineCustomElement.es6(className, tagName, superClass))
    ...
    ast.program.body.push(defineCustomElement.es5(className, tagName, superClass))
