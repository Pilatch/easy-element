...
function (_HTMLElement) {
  _inherits(HyperLink, _HTMLElement);
  ...
  _createClass(HyperLink, [{
    ...
    value: function connectedCallback() {
      ...
      ['href', 'tabindex', 'target'].forEach(function (attribute) {
        anchor.setAttribute(attribute, _this.getAttribute(attribute));
      });
    }
  }]);
...
(function () {
  ...
  style.textContent = 'hyper-link a {  color: green;  font-style: italic;}';
