...
function (_HTMLElement) {
  _inherits(NestEgg, _HTMLElement);

  function NestEgg() {
    _classCallCheck(this, NestEgg);

    return _possibleConstructorReturn(this, _getPrototypeOf(NestEgg).apply(this, arguments));
  }

  _createClass(NestEgg, [{
